 ...
 * @author NOMI Ph.D
 */
public class Categorie_Ctrl extends Res{
    
    private final Categorie_Vue View;
    private final String LaClasse = tchimgescom.Serveur.Produit.Categorie.class.getName();
    
    
    public Categorie_Ctrl(){
         View=new Categorie_Vue(this);
    }
    ...
    {   
        if (((String)Nom).equals("")){
            MessageDlg("Indiquer le code de la catégorie des produits");
            return false;
        }
        return true;
    }
